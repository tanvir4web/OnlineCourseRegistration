              ...
              <tr>
                <td class="title">
                  ...
                  <?php }                   
                    ...
                    {?>
                      <img
                          src="studentphoto/<?php echo htmlentities($row['photo']);?>"
                          width="200"
                           height="200"
                      />
                  <?php } ?>
                    ...
                    <td>
                      <b> ID : </b>
                      <?php echo htmlentities($_SESSION['login']);?><br /> <br /> 
                  <b> Student Name: </b>
                  <?php echo htmlentities($row['studentname']);?><br /><br /> 
                  <b> Student Reg. Date:</b>
                  <?php echo htmlentities($row['studentregdate']);?><br /><br /> 
                  <b> Course Reg. Date:</b>
                  <?php echo htmlentities($row['edate']);?><br /><br /> 
                </td>
              </tr>
            </table>
          </td>
